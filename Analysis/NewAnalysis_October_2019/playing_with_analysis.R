...
testing_uof <- read_csv("cleaned_oct_2019_uof.csv")
...
officers_involved_in_cit_num_11890 <- testing_uof %>% 
  filter(CITNUM == 11890) %>% 
  count(OFF_NUM)
View(officers_involved_in_cit_num_11890)



cit_num_18906  <- testing_uof %>%
  filter(CITNUM == 18906) %>%
  select(
    CITNUM,
    STREET_N,
  ...
  count(UOF_FORCE_TYPE)
View(cit_num_18906)


officers_involved_in_cit_num_18906 <- testing_uof %>% 
  filter(CITNUM == 18906) %>% 
  count(OFF_NUM)
View(officers_involved_in_cit_num_18906)
